...
public class HipHopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HipHop.add(new CategoryItem("Dr. Dre", R.drawable.dre));
        HipHop.add(new CategoryItem("Snoop Dogg", R.drawable.dogg));
        HipHop.add(new CategoryItem("Eminem", R.drawable.eminem));
        HipHop.add(new CategoryItem("Logic", R.drawable.logic));
        HipHop.add(new CategoryItem("SOB x RBE", R.drawable.sob));
